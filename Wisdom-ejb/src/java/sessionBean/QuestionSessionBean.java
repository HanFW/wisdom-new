...
public class QuestionSessionBean implements QuestionSessionBeanLocal {
    ...
    public void replyToQuestion(Long questionId, String reply) {
        ...
        if (question == null) {
            ...
            Double todayQuestionIncome = question.getAuthor().getTodayQuestionIncome();
            if (LocalDateTime.now().getDayOfYear() != question.getAuthor().getToday()) {
                todayQuestionIncome = question.getPrice();
                question.getAuthor().setToday(LocalDateTime.now().getDayOfYear());
                question.getAuthor().setTodayQuestionIncome(todayQuestionIncome);
            } else {
                todayQuestionIncome = todayQuestionIncome + question.getPrice();
                question.getAuthor().setTodayQuestionIncome(todayQuestionIncome);
            }
